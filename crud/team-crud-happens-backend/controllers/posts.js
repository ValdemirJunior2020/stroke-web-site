...
export const createPost = async(req, res, next) => {
    ...
    try {
        ...
        const blobWriter = blob.createWriteStream({ //"Binary Large Object" //A blob is a data type that can store binary data. 
            metadata: {
                contentType: req.file.mimetype, //A MIME type is a label used to identify a type of data. It is used so software can know how to handle the data.
            },
        });
